              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    $sql = "SELECT ri.id, ri.invoiceId, ri.exemption, ri.invoiceDate, ri.paid, ri.dueDate, ri.occurenceType, ri.customerName, ri.feeCode, ri.feeName, ri.contractNo, ri.contractName, ri.contractStartDate, ri.contractEndDate, ri.amount, ri.charged
                            FROM rental_invoice ri
                            WHERE ri.invoiceDate BETWEEN '$fromDate' AND '$toDate' AND ri.feeCode = '$feetypesearch'
                            ORDER BY ri.id ASC";
                    ...
                    $result = $connection->query($sql);
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        if ($row['exemption'] != 0.00){
                          $invoicefee=($row['exemption']/100)*$row['amount'];
                        }
                      echo "<tr>";
