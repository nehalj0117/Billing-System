...
if (isset($_GET['id'])) { //get the post value from invoice_approved
  $invoiceID = $_GET['id'];
  $sql = "SELECT * FROM opr_invoice WHERE id = ?";
  ...
  if($result->num_rows == 1) {
    ...
    $id = $row["invoice_id"];
    $cusFullName = $row["cusName"];// get data from DB
    $invoiceDate = $row["invoiceDate"];// get data from DB
    $dueDate = $row["dueDate"];
    $period = $row["invoicePeriod"];//get period from DB
    $invoicePeriod = $row["invoicePeriod"];
    $exemption = $row["discount"];
    $notice1 =  $row["notice1"];// get data from DB
    $notice2 =  $row["notice2"];// get data from DB
    $notice3 =  $row["notice3"];// get data from DB
    $invoicePeriod = $row["invoicePeriod"];
    if($row["invoiceType"]=='AIRCRAFT CHARGES'){
      $feeDescription1 = "Approch fee";
      $fee1 = $row["approchFee"];
      $feeDescription2 = "Landing & lighting fee";
      $fee2 = $row["landFee"];
      $feeDescription3 = 'Parking fee';
      $fee3 = $row["parkFee"];;
      $feeDescription4 = "Passenger boarding bridge";
      $fee4 = $row["pbbFee"];;
      $totalfee=$fee1+ $fee2+$fee3+$fee4;
    }
    if($row["invoiceType"]=='PASSENGER TAX'){
      $feeDescription1 = "Passenger check-in";
      $fee1 = $row["checkFee"];
      $feeDescription2 = "Transit passenger";
      $fee2 = $row["transitFee"];
      $feeDescription3 = "Passenger TAX";
      $fee3 = $row["taxFee"];
      $feeDescription4 = "";
      $fee4 = "";
    ...
    if($row["invoiceType"]=='PASSENGER CHARGES'){
      $feeDescription1 = "Departing Passenger";
      $fee1 = $row["depPaxFee"];
      $feeDescription2 = "Arriving Passenger";
      $fee2 = $row["arrPaxFee"];
      $feeDescription3 = '';
      $fee3 = "";
      $feeDescription4 = "";
    ...
    $exemptedFee = $totalfee*$exemption/100;
    $invoiceFee= $totalfee - $exemptedFee;
    ...
    <div class="page-content">
      ...
      <div class="customer-section">
          ...
          <div class="invoiceperiod">
            <div class="invoicedate"></br></br></br></br><?php echo $invoicePeriod; ?></div>
          </div>
        </div>
      </div>
      ...
      <table class="fee-details" style="width: 100%;">
        ...
        <tr>
          <td colspan="2" class="itemscell"><?php 
            echo $feeDescription1;     
          ?>
          <td class="itemscell3">
            <?php 
            echo number_format($fee1,3);
            ?></td>
        </tr>
        <tr>
          <td colspan="2" class="itemscell">
          <?php 
            echo $feeDescription2;    
          ?>            
          </td>
          <td class="itemscell3">
          <?php 
            echo number_format($fee2,3);
            ?>  
          </td>
        </tr>
        <tr>
          <td colspan="2" class="itemscell">
          <?php 
            echo $feeDescription3;    
          ?>            
          </td>
          <td class="itemscell3">
          <?php           
          if($fee4 !=""){
            echo number_format($fee3,3);}
            ?>  
          </td>
        </tr>
        <tr>
          <td colspan="2" class="itemscell">
          <?php 
            echo $feeDescription4;    
          ?>            
          </td>
          <td class="itemscell3">
          <?php 
          if($fee4 !=""){
            echo number_format($fee4,3);}
            ?>  
          </td>
        </tr>
        <tr>
        ...
        <tr class="total-row">
          ...
          <td class="total-amount"><?php echo number_format($totalfee,3); ?></td>
        </tr>
      <tr class="total-row">
        <td colspan="2"></td>
        ...
        <tr class="total-row">
          ...
          <td style="font-weight: bold;">KD</td>
          <td class="total-amount"><?php
                      echo number_format($invoiceFee,3); ?></td>
        </tr>
      </table>
    </div>
      ...
      <div class="footer">
        ...
        <div class="notice-box">
          ...
          <?php echo $notice1; ?><br><br>
          <?php echo $notice2; ?><br><br>
          <?php echo $notice3; ?><br>
        </div>
      </div>
