...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $selectQuery = "SELECT totalPaid, totalFee FROM opr_invoice WHERE id = ?";
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $query = "UPDATE opr_invoice SET totalPaid = totalPaid + ? WHERE id = ?";
