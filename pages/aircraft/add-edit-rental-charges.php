          ...
          <li class="nav-item">
              ...
              <div class="collapse" id="aircraft-menu">
                  <ul class="nav flex-column sub-menu">
                      ...
                      <li class="nav-item">
                          <a class="nav-link" href="../../pages/aircraft/add-edit-invoice-rental-comments.php">Edit Invoice Comments</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link" href="../../pages/aircraft/add-edit-rental-charges.php">Edit Charges</a>
                      </li>
                  </ul>
              </div>
          </li>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      $fromDate = date($currentYear.'-'.$currentMonth.'-01 00:00:00');
                      ...
                      if ($result->num_rows > 0) {
                          while ($row = $result->fetch_assoc()) {
                              ...
                              $parkingFees = ($row['AorD'] === 'D') ? (($totalhourround > $freeHours) ? ($totalhourround - $freeHours) * $parkingFeePerHour : 0) : 0;
