...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO opr_invoice (cusID, cusName, invoiceDate, dueDate, invoiceType, depPaxFee, arrPaxFee, totalFee, invoicePeriod) VALUES (?, ?, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 30 DAY), ?, ?, ?, ?, ?)");
